...
export abstract class BaseEndpoint {
    ...
    getDistance<T>(params: IEndpointParams) {
        const reqParams = this.setReqParameters(params);
        const headers = { 'content-type': 'application/json' }
        // console.log(`https://router.project-osrm.org/route/v1/driving/${params}?overview=false&alternatives=true&steps=true&hints=`)
        return this.http.get<T[]>(`https://router.project-osrm.org/route/v1/driving/${params}?overview=false&alternatives=true&steps=true`, { 'headers': headers });
    }
