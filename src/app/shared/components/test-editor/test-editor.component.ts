...
export class TestEditorComponent extends BaseComponent<any> {
			...
			let page = `
					<div class='st_area_editor${this.page_number}' id='st_area_editor${this.page_number}' 
						...
						overflow: hidden;">
					  		...
					  		<div contentEditable=${!this.disableEditor} class="wordreportcontent${this.page_number}" 
	...
	getHeight(content: string = this.header_to_diplay_in_every_page): any {
