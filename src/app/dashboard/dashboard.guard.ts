  ...
  canActivate(
    ...
    if (!access || !refresh) {
      ...
      return false;
        ...
        // Check if user type is 3 (staff member) and grant access directly
      if (this.cookieSrvc.getUserType() == 1) {
        return true;
      }
  
      return this.endPoint.pageQuardAuth(this.cookieSrvc.getCookieData().lab_staff_id, 1).pipe(
        switchMap((res: any)=>{
