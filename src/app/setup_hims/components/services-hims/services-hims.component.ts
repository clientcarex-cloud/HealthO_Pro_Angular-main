...
import { HIMSSetupEndpoint } from './hmis.endpoint';
import { MasterEndpoint } from 'src/app/setup/endpoint/master.endpoint';
import { AddServiceComponent } from '../add-service/add-service.component';
import { CookieStorageService } from 'src/app/core/services/cookie-storage.service';

@Component({
  selector: 'app-services-hims',
  templateUrl: './services-hims.component.html',
  styleUrl: './services-hims.component.scss'
})
export class ServicesHimsComponent extends BaseComponent<any> {
  ...
  getData() {
    ...
    this.subsink.sink = this.endPoint.getServices(
